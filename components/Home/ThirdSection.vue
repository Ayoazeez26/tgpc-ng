...
<template>
  <div class="py-[140px] lg:py-[112px] mx-auto w-full max-w-[1312px]">
    <div
      class="flex flex-col px-4 lg:px-0 items-center justify-center w-full"
    >
      <div class="w-full flex flex-col gap-6 md:ml-4 max-w-[768px] text-center">
        ...
        >
          Streamline Your Operations with Our Outsourcing Solutions
        </h2>

        <p class="leading-7 md:text-lg md:leading-[150%]">
          Our cost-effective and time-saving services provide professional commitment and access to expert staff.
        </p>
      </div>
      <div class="mt-20 gap-8 flex justify-center flex-wrap w-full">
        <div class="border border-grey-3 bg-white rounded-2xl w-full md:max-w-[384px] gap-2 flex flex-col items-center px-6 pb-8 text-center">
          <img class="-translate-y-7" src="/img/cost.png" alt="cost">
          <h3 class="text-xl font-bold -mt-5 leading-[140%]">Cost-Effective Solutions</h3>
          <p class="leading-[150%]">Save money by outsourcing essential departments to us.</p>
        </div>
        <div class="border border-grey-3 bg-white rounded-2xl w-full md:max-w-[384px] gap-2 flex flex-col items-center px-6 pb-8 text-center">
        ...
        <div class="flex w-full gap-6 md:w-auto mt-12 pt-4">
          <nuxt-link
            to="#contact"
